...
// AES加密解密类填充模式是AES/CBC/PKCS5Padding
...
public class AESCrypto {
    ...
    private static SecretKeySpec initKey(String mkey) {
        byte[] key;
    ...
    public static String encrypt(String key, String message) {
        ...
        try {
            ...
            encode = Base64.encodeToString(cipher.doFinal(message.getBytes("UTF-8")), Base64.NO_WRAP);
            return encode;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String decrypt(String key, String enMessage) {
        ...
        try {
            ...
            message = new String(cipher.doFinal(Base64.decode(enMessage, Base64.NO_WRAP)));
            return message;
        } catch (Exception e) {
            e.printStackTrace();
        }
